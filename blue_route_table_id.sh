...
export ICN_VPC_Blue_PublicRT_id=$(aws ec2 describe-route-tables --filters 'Name=tag:Name,Values=ICN-VPC-Blue-PublicRT' --region ap-northeast-2 | jq -r '.RouteTables[].RouteTableId')
...
export ICN_VPC_Blue_Private_Subnet_A_RT_id=$(aws ec2 describe-route-tables --filters 'Name=tag:Name,Values=ICN-VPC-Blue-Private-Subnet-A-RT' --region ap-northeast-2 | jq -r '.RouteTables[].RouteTableId')
...
export ICN_VPC_Blue_Private_Subnet_B_RT_id=$(aws ec2 describe-route-tables --filters 'Name=tag:Name,Values=ICN-VPC-Blue-Private-Subnet-B-RT' --region ap-northeast-2 | jq -r '.RouteTables[].RouteTableId')
...
echo "export ICN_VPC_Blue_PublicRT_id=${ICN_VPC_Blue_PublicRT_id}"| tee -a ~/.bash_profile
...
echo "export ICN_VPC_Blue_Private_Subnet_A_RT_id=${ICN_VPC_Blue_Private_Subnet_A_RT_id}"| tee -a ~/.bash_profile
...
echo "export FRA_VPC_Blue_Private_Subnet_A_RT_id=${FRA_VPC_Blue_Private_Subnet_A_RT_id}"| tee -a ~/.bash_profile
echo "export DUB_VPC_Blue_Private_Subnet_A_RT_id=${DUB_VPC_Blue_Private_Subnet_A_RT_id}"| tee -a ~/.bash_profile

echo "export ICN_VPC_Blue_Private_Subnet_B_RT_id=${NRT_VPC_ICN_Private_Subnet_B_RT_id}"| tee -a ~/.bash_profile
