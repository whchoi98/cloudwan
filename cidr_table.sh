...
export ICN_VPC_Blue_CIDR='10.11.0.0/16'
...
echo "export ICN_VPC_Blue_CIDR=${ICN_VPC_Blue_CIDR}"| tee -a ~/.bash_profile
...
export ICN_VPC_Green_CIDR='10.22.0.0/16'
...
echo "export ICN_VPC_Green_CIDR=${ICN_VPC_Green_CIDR}"| tee -a ~/.bash_profile
